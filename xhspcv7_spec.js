// xhspcv7.spec.js · 小红书PC完整主系统 V2.0补强 · TL真浏览器回归
// 运行:npx playwright test xhspcv7.spec.js
// URL:改为 https://infinity-os-sh.github.io/Infinity-os-SH/xhspcv7.html 或本地 file://
const { test, expect } = require('@playwright/test');
const URL = process.env.XURL || 'https://infinity-os-sh.github.io/Infinity-os-SH/xhspcv7.html';
